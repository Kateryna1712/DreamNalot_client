                ...
                <div className={styles.form}>
                    <div className={styles.input_container}>
                        <input
                            ...
                            className={errors.name ? styles.form_input_error : styles.form_input}
                            type="text"
                    ...
                    <div className={styles.form__contact_inputs}>
                        <div className={styles.input_container}>
                            <input
                                ...
                                className={errors.email ? styles.form_input_error : styles.form_input}
                                type="email"
                        ...
                        <div className={styles.input_container}>
                            <input {...register('phoneNumber', {
                                pattern: { value: /^\+\d{3}\d{9}$/, message: 'Phone number is not valid' },
                                required: { value: true, message: 'Phone is required!' }
                            })}
                                className={errors.phoneNumber ? styles.form_input_error : styles.form_input}
                                type="tel"
                                placeholder='Your Phone Number' />
                            <span className={styles.error}>{errors.phoneNumber?.message}</span>
                        </div>
                    </div>
                    <input {...register('comment')} className={styles.form_input}
                        type="text"
